    ...
    public function run(): void
    {
        ...
        $rows = [
            [
                ...
                'meta_description' => ['ro' => 'Standarde germane în România: lemn de foc, exploatare forestieră, achiziție masă lemnoasă și transport în Prahova, Ilfov și București.', 'de' => null, 'en' => null],
                ...
                'sectiuni' => [
                    [
                        'type' => 'hero',
                        'data' => [
                            'badge' => ['ro' => 'Servicii forestiere și lemn de foc', 'de' => null, 'en' => null],
                            'badge_link' => ['ro' => 'Vezi serviciile', 'de' => null, 'en' => null],
                            'badge_url' => '/servicii',
                            'titlu' => ['ro' => 'Pădurea, gestionată cu responsabilitate', 'de' => null, 'en' => null],
                            'subtitlu' => ['ro' => 'Recoltare durabilă, lemn de foc de calitate și servicii forestiere profesionale în Prahova, Ilfov și București.', 'de' => null, 'en' => null],
                            'cta_text' => ['ro' => 'Cere ofertă', 'de' => null, 'en' => null],
                            'cta_url' => '/contact',
                            'chips' => [
                                [
                                    'icon' => 'flacara',
                                    'text' => ['ro' => 'Lemn de foc', 'de' => null, 'en' => null],
                                    'tooltip' => ['ro' => 'Esențe tari (stejar, carpen, fag), livrate acasă.', 'de' => null, 'en' => null],
                                ],
                                [
                                    'icon' => 'copaci',
                                    'text' => ['ro' => 'Exploatare forestieră', 'de' => null, 'en' => null],
                                    'tooltip' => ['ro' => 'Prestări servicii în păduri private și de stat.', 'de' => null, 'en' => null],
                                ],
                                [
                                    'icon' => 'handshake',
                                    'text' => ['ro' => 'Achiziție masă lemnoasă', 'de' => null, 'en' => null],
                                    'tooltip' => ['ro' => 'Pe picior sau fasonată — evaluare corectă.', 'de' => null, 'en' => null],
                                ],
                                [
                                    'icon' => 'excavator',
                                    'text' => ['ro' => 'Curățare terenuri', 'de' => null, 'en' => null],
                                    'tooltip' => ['ro' => 'Defrișare controlată, fără suprafață minimă.', 'de' => null, 'en' => null],
                                ],
                                [
                                    'icon' => 'frunza',
                                    'text' => ['ro' => 'Certificare FSC & PEFC', 'de' => null, 'en' => null],
                                    'tooltip' => ['ro' => 'Surse responsabile, în proces de certificare.', 'de' => null, 'en' => null],
                                ],
                                [
                                    'icon' => 'camion',
                                    'text' => ['ro' => 'Livrare locală', 'de' => null, 'en' => null],
                                    'tooltip' => ['ro' => 'Prahova, Ilfov, București · 1-3 zile.', 'de' => null, 'en' => null],
                                ],
                            ],
                        ],
                    ],
                    [
                        ...
                        'data' => [
                            ...
                            'titlu_mare' => ['ro' => 'Scoatem pădurea din ceață.', 'de' => null, 'en' => null],
                            'tagline' => ['ro' => 'Limpede, de la pădure până la tine.', 'de' => null, 'en' => null],
                            'intro' => ['ro' => 'Suntem partenerul tău forestier din Prahova: recoltăm responsabil, transportăm și livrăm lemn de calitate — cu experiența și standardele grupului german Galle. Fără bătăi de cap, fără surprize.', 'de' => null, 'en' => null],
                        ],
                    ],
                    [
                        'type' => 'splitter',
                    ...
                    [
                        ...
                        'data' => [
                            ...
                            'continut' => ['ro' => 'Galle Silva aduce în România experiența grupului german Galle GmbH — aproape 25 de ani în silvicultură. Lucrăm cu utilaje moderne (harvester și forwarder), echipă specializată și autospeciale proprii, în păduri private și de stat. De la recoltare la livrare, ducem lucrarea cap-coadă, corect și transparent.', 'de' => null, 'en' => null],
                    ...
                    [
                        ...
                        'data' => [
                            ...
                            'items' => [
                                [
                                    'icon' => 'copaci',
                                    'titlu' => ['ro' => 'Exploatare forestieră', 'de' => null, 'en' => null],
                                    'text' => ['ro' => 'Recoltăm lemnul cu harvester și forwarder, în păduri private și de stat. Tăiere, fasonare și scos-apropiat — lucrare completă.', 'de' => null, 'en' => null],
                                    'imagine' => '/images/galle/proiecte/harvester-lucru-wide.webp',
                                    'url' => '/servicii/exploatare-forestiera',
                                ],
                                [
                                    'icon' => 'handshake',
                                    'titlu' => ['ro' => 'Achiziție masă lemnoasă', 'de' => null, 'en' => null],
                                    'text' => ['ro' => 'Cumpărăm masă lemnoasă pe picior sau fasonată. Evaluăm corect și plătim transparent. Ai pădure de valorificat? Vorbește cu noi.', 'de' => null, 'en' => null],
                                    'imagine' => '/images/galle/proiecte/busteni-marcati-wide.webp',
                                    'url' => '/servicii/achizitie-masa-lemnoasa',
                                ],
                                [
                                    'icon' => 'excavator',
                                    'titlu' => ['ro' => 'Curățare și defrișare terenuri', 'de' => null, 'en' => null],
                                    'text' => ['ro' => 'Curățăm terenul de copaci, arbuști și cioate — pentru construcții sau agricultură. Fără suprafață minimă.', 'de' => null, 'en' => null],
                                ...
                                [
                                    ...
                                    'text' => ['ro' => 'Transportăm lemnul cu autospeciale proprii, din pădure până la depozit sau la tine.', 'de' => null, 'en' => null],
                                ...
                                [
                                    ...
                                    'text' => ['ro' => 'Esențe tari — stejar, carpen, fag — livrate în Prahova, Ilfov și București.', 'de' => null, 'en' => null],
                                    'imagine' => '/images/galle/proiecte/gramada-busteni-wide.webp',
                                    'url' => '/lemn-de-foc',
                                ],
                                [
                                    'icon' => 'frunza',
                                    'titlu' => ['ro' => 'Lucrări silvice & documentație', 'de' => null, 'en' => null],
                                    'text' => ['ro' => 'Rărituri, curățiri și actele aferente (APV, documente de însoțire). Te ghidăm de la cap la coadă.', 'de' => null, 'en' => null],
                    ...
                    [
                        ...
                        'data' => [
                            ...
                            'items' => [
                                [
                                    'titlu' => ['ro' => 'Calitate germană', 'de' => null, 'en' => null],
                                    'text' => ['ro' => 'Procese și standarde Galle GmbH, aplicate la fiecare comandă și proiect.', 'de' => null, 'en' => null],
                                    'icon' => 'heroicon-o-check-badge',
                                ],
                                [
                                    'titlu' => ['ro' => 'Recoltare durabilă', 'de' => null, 'en' => null],
                                    'text' => ['ro' => 'Păduri gestionate responsabil, certificări FSC și PEFC în lucru.', 'de' => null, 'en' => null],
                                    'icon' => 'heroicon-o-globe-europe-africa',
                                ],
                                [
                                    'titlu' => ['ro' => 'Livrare rapidă', 'de' => null, 'en' => null],
                                    'text' => ['ro' => 'Lemn de foc livrat în 2-5 zile în Prahova, Ilfov și București.', 'de' => null, 'en' => null],
                                    'icon' => 'heroicon-o-truck',
                                ],
                                [
                                    'titlu' => ['ro' => 'Pentru firme și instituții', 'de' => null, 'en' => null],
                                    'text' => ['ro' => 'Servicii forestiere, transport și curățare terenuri, cu factură și plată la termen.', 'de' => null, 'en' => null],
                    ...
                    [
                        'type' => 'galerie',
                        'data' => [
                            'titlu' => ['ro' => 'De la fața locului', 'de' => null, 'en' => null],
                            'imagini' => [
                    ...
                    [
                        ...
                        'data' => [
                            ...
                            'text' => ['ro' => 'Lemnul de foc Galle Silva provine din păduri gestionate responsabil — o resursă regenerabilă. Certificări FSC și PEFC în lucru, în acord cu principalele standarde de sustenabilitate.', 'de' => null, 'en' => null],
                            'stat_number' => '100%',
                    ...
                    [
                        'type' => 'cta',
                        'data' => [
                            'titlu' => ['ro' => 'Vrei o ofertă personalizată?', 'de' => null, 'en' => null],
                            'text' => ['ro' => 'Pentru lemn de foc, exploatare forestieră sau transport — spune-ne ce ai nevoie și te contactăm în 24h.', 'de' => null, 'en' => null],
                            'buton_text' => ['ro' => 'Cere ofertă', 'de' => null, 'en' => null],
                            'buton_url' => '/contact',
                        ],
                    ],
                ],
