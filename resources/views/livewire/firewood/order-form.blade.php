...
<div>
    ...
    @else
        <form wire:submit.prevent="submit" class="bg-[#fafaf8] border border-forest rounded-2xl p-6 space-y-4">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="of-nume" type="text" wire:model="nume" required class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint">
                ...
                <div>
                    ...
                    <input id="of-telefon" type="tel" wire:model="telefon" required class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="of-email" type="email" wire:model="email" class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint">
                    @error('email') <p class="text-xs text-rose-600 mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="of-localitate" class="text-sm font-medium block mb-1">{{ __('Localitate') }} *</label>
                    <input id="of-localitate" type="text" wire:model="localitate" required class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint">
            ...
            <div class="grid sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <select id="of-specie" wire:model="specieId" class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint">
                ...
                <div>
                    ...
                    <input id="of-cantitate" type="number" min="0.5" step="0.5" wire:model="cantitate" required class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint">
                </div>
                <div>
                    <label for="of-unitate" class="text-sm font-medium block mb-1">{{ __('Unitate') }}</label>
                    <select id="of-unitate" wire:model="unitate" class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint">
            ...
            <div>
                ...
                <input id="of-data" type="date" wire:model="data_dorita" min="{{ now()->toDateString() }}" class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint">
            </div>

            <div>
                <label for="of-mesaj" class="text-sm font-medium block mb-1">{{ __('Mesaj (optional)') }}</label>
                <textarea id="of-mesaj" wire:model="mesaj" rows="3" class="w-full rounded-lg border border-forest bg-white px-3 py-2 focus:border-mint focus:ring-mint"></textarea>
            </div>

            <div>
                <label for="of-gdpr" class="flex items-start gap-2 text-sm text-forest-dark/80">
                    <input id="of-gdpr" type="checkbox" wire:model="gdpr" class="mt-0.5 rounded border border-forest text-forest focus:ring-mint">
