        ...
        <section class="py-16 lg:py-20">
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <h2 class="mt-3 font-display text-3xl font-semibold text-forest">{{ __('Certificari ale grupului Galle GmbH') }}</h2>
                </div>
        ...
        <section class="bg-mist-warm py-16 lg:py-20">
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <h2 class="mt-3 font-display text-3xl font-semibold text-forest">{{ __('In proces de certificare') }}</h2>
                </div>
